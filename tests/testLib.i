...
%INSTANTIATE(InvalidParameterError)
%INSTANTIATE(LengthError)
%INSTANTIATE(OutOfRangeError)
%INSTANTIATE(RuntimeError)
%INSTANTIATE(RangeError)
%INSTANTIATE(OverflowError)
%INSTANTIATE(UnderflowError)
%INSTANTIATE(NotFoundError)
%INSTANTIATE(MemoryError)
%INSTANTIATE(IoError)
